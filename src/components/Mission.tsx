...
export default function Mission() {
  ...
  return (
      ...
      <div className="container mx-auto px-4">
        ...
        >
          <div className="flex flex-col items-center gap-10 mb-16">
            <div className="inline-block bg-blue-50 dark:bg-blue-900/20 px-6 py-2 rounded-full">
               <span className="text-blue-600 dark:text-blue-400 font-bold tracking-wide text-lg uppercase block">
                 {t("About Company", "عن الشركة")}
               </span>
            </div>
            
            <div className="relative inline-block">
              <h2 className="text-3xl md:text-5xl font-bold text-white font-arabic relative z-10 pb-4">
          ...
          <div className="relative inline-block max-w-4xl mx-auto px-6 mb-16">
            ...
            <p className={`text-xl md:text-3xl leading-relaxed text-gray-300 font-arabic relative z-10 font-light ${language === 'en' ? 'font-sans' : ''}`} dir={language === 'ar' ? 'rtl' : 'ltr'}>
              {language === 'ar' ? (
                <>
          ...
          <div className="grid md:grid-cols-2 gap-12 text-center max-w-4xl mx-auto" dir={language === 'ar' ? 'rtl' : 'ltr'}>
            <div className="space-y-4">
              <h3 className="font-bold text-2xl text-blue-400">{t("Our Mission", "رسالتنا")}</h3>
            ...
            <div className="space-y-4">
              <h3 className="font-bold text-2xl text-blue-400">{t("Our Values", "قيمنا")}</h3>
              <p className="text-gray-400 text-lg leading-relaxed">
    ...
    <section id="features" className="py-20 bg-zinc-800 relative overflow-hidden">
      <NetworkAnimation />
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8" dir={language === 'ar' ? 'rtl' : 'ltr'}>
          {features.map((feature, index) => (
            <motion.div
              ...
              className="p-6 text-center group bg-white/5 hover:bg-white/10 rounded-2xl transition-all shadow-sm hover:shadow-md border border-white/10"
            >
              <div className="bg-zinc-900 w-16 h-16 rounded-2xl rotate-3 group-hover:rotate-6 transition-transform flex items-center justify-center mx-auto mb-6 text-blue-500 shadow-sm">
                {feature.icon}
              </div>
              <h3 className="text-xl font-bold mb-3 text-white font-arabic">
                {language === 'en' ? feature.title.en : feature.title.ar}
              </h3>
              <p className="text-gray-300 font-arabic leading-relaxed text-sm">
